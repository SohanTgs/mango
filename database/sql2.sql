...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2022 at 04:34 PM
...
(1, 'pbkdf2_sha256$320000$4BkKNvjjMWWuic5rglZB2h$OsijdDM9y+hY+hKxqnY6LSsON/ywsxefLtX6noO8i8s=', '2022-02-24 13:47:38.115065', 1, 'admin', '', '', 'admin@gmail.com', 1, 1, '2021-11-24 12:29:04.755174');
...
('8kkqd7y39tpqni7j0vxhm1aargrmnegh', '.eJxVjrtygzAQRf9FbWzNslqEoHSfLr1mJZZHzKAxEpXH_x6YuEja-zj3PpXnvUx-z7L5uVedqtTlrxY43mU9jf6b1zHpmNayzUGfEf12s_5MvSy3d_YfYOI8HW3DxtSBQMS2jWVuexSIHJ11SJUEdCjCZMmKc62hIbhIQ2McDa6uIhzQ3wMnOvkljWkvfuFc_CaPXXI5RhAQr4BXpK-Kutp22OqaGtPQB0AHoF4_EtdMHA:1nNFXh:panq1GOdzJxv1UzlZTgnR7aTsXuYoiEO496WSzFDgro', '2022-03-10 14:56:29.648118');
...
(1, '[\"Admin\", \"sohan\", \"mango\", \"python\", \"laravel\", \"hello python\", \"php\"]', 'Description', 'seo/nams_m76qKej.png', '2022-02-23 08:18:48.303565', '2021-12-17 00:39:06.000000');
...
INSERT INTO `general_setting` (`id`, `email_from`, `email_template`, `mail_config`, `site_name`, `cur_text`, `cur_sym`, `base_color`, `g_translate`, `agree_policy`, `registration`, `force_ssl`, `logo`, `favicon`, `updated_at`, `created_at`) VALUES
(1, 'mofoti@mailinator.com', '<br style=\"font-family: Lato, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, sans-serif;\"><br style=\"font-family: Lato, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, sans-serif;\"><div class=\"contents\" style=\"font-family: Lato, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, &quot;Helvetica Neue&quot;, Arial, sans-serif; max-width: 600px; margin: 0px auto; border: 2px solid rgb(0, 0, 54);\"><div class=\"header\" style=\"background-color: rgb(0, 0, 54); padding: 15px; text-align: center;\"><div class=\"logo\" style=\"width: 260px; margin: 0px auto;\">&nbsp;</div></div><div class=\"mailtext\" style=\"padding: 30px 15px; background-color: rgb(240, 248, 255); font-family: &quot;Open Sans&quot;, sans-serif; line-height: 26px;\">Hi {{username}}&nbsp;<br><br><br><br></div><div class=\"footer\" style=\"background-color: rgb(0, 0, 54); padding: 15px; text-align: center; border-top: 1px solid rgba(255, 255, 255, 0.2);\"><span style=\"color: rgb(255, 255, 255); font-weight: bolder;\">© Sohan Limited. All Rights Reserved.</span><p style=\"color: rgb(221, 221, 221);\">This is a system-generated email and only for demonstration purposes.</p><p style=\"color: rgb(221, 221, 221);\">Please change this from admin panel.<br></p><div><br></div></div></div><table class=\"layout layout--no-gutter\" align=\"center\" style=\"caption-side: bottom; width: 1553px; font-family: Poppins, sans-serif; border-spacing: 0px; color: rgb(52, 73, 94); table-layout: fixed; margin-left: auto; margin-right: auto; overflow-wrap: break-word; word-break: break-word;\"><tbody style=\"border-style: solid; border-width: 0px;\"></tbody></table>', '{\"name\": \"smtp\", \"EMAIL_HOST\": \"localhost\", \"EMAIL_PORT\": \"25\", \"EMAIL_USE_TLS\": false, \"EMAIL_USE_SSL\": true, \"EMAIL_HOST_USER\": \"*******\", \"EMAIL_HOST_PASSWORD\": \"*******\"}', 'Mango', 'USD', '$', '60d14b', 1, 0, 0, 0, 'logo_icon/unnamedfsadfsadfasdf.png', 'logo_icon/iconsssssss.png', '2022-02-24 06:35:01.989670', '2021-12-10 21:19:44.000000');
...
--
-- Indexes for table `general_seo`
--
ALTER TABLE `general_seo`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `general_seo`
--
ALTER TABLE `general_seo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
